...
\begin{document}
    ...
    \begin{tikzpicture}[use Hobby shortcut]
        ...
        \node at (\kt+1.35,10.2) {\large 11.98};
        \node at (\kt+1.96,9.6) {\large 6.38};
        ...
        \node at (\width*0.5,-2-2*\las) {\textsf{119, 123 \textbf{HV5}}};
    ...
    \begin{tikzpicture}[use Hobby shortcut]
        ...
        \node at (\kt,10.2) {\textsf{\textbf{W\kern-0.07em I\kern-0.07em D\kern-0.07em T\kern-0.07em H =}}};
        \node at (\kt+0.35,9.6) {\textsf{\textbf{T\kern-0.07em H\kern-0.07em I\kern-0.07em C\kern-0.07em K\kern-0.07em N\kern-0.07em E\kern-0.07em S\kern-0.07em S =}}};
        \node at (\kt+1.15,10.2) {\large 12};
        \node at (\kt+1.96,9.6) {\large 6.18};
        ...
        \draw[line width=0.2mm] (\width-0.1,1) -- (\width+0.2,1) node[right] {\Large \textsf{FOR 90 MINS}};
        \Large
        \def\las{0.6}
        \node at (\width*0.5,-2) {\textsf{\textbf{VICKERS}}};
        \node at (\width*0.5,-2-\las) {\textsf{\textbf{HARDNESS}}};
        \node at (\width*0.5,-2-2*\las) {\textsf{36, 36.8 \textbf{HV5}}};
    ...
    \begin{tikzpicture}[use Hobby shortcut]
        ...
        \node at (\kt,10.2) {\textsf{\textbf{W\kern-0.07em I\kern-0.07em D\kern-0.07em T\kern-0.07em H =}}};
        \node at (\kt+0.35,9.6) {\textsf{\textbf{T\kern-0.07em H\kern-0.07em I\kern-0.07em C\kern-0.07em K\kern-0.07em N\kern-0.07em E\kern-0.07em S\kern-0.07em S =}}};
        \node at (\kt+1.4,10.2) {\large 11.97};
        \node at (\kt+1.96,9.6) {\large 6.08};
        ...
        \draw[line width=0.2mm] (\width-0.1,1) -- (\width+0.2,1) node[right] {\Large \textsf{FOR 90 MINS = ST}};
        \draw[line width=0.2mm] (\width-0.1,0.35) -- (\width+0.2,0.35) node[right] {\Large \textsf{FOR 40 MINS = PH}};
        
        \Large
        \def\las{0.6}
        \node at (\width*0.5,-2) {\textsf{\textbf{VICKERS}}};
        \node at (\width*0.5,-2-\las) {\textsf{\textbf{HARDNESS}}};
        \node at (\width*0.5,-2-2*\las) {\textsf{\st{102.8}, 131, 126 \textbf{HV5}}};
