...
Pressure measurement fundamentally relies on observing its physical effects on measurable systems. The accompanying figures demonstrate three classical approaches:\\[8pt]
\begin{minipage}{1\textwidth}
...
\vspace{-1em} \subsection{Absolute Pressure}
...
\begin{center}
	\begin{tblr}{
		...
		\SetCell{bg=black!20!white,fg=black}\textbf{Unit} & \textbf{Pa} & \textbf{bar} & \textbf{psi} & \textbf{atm} & \textbf{cm Hg} \\
