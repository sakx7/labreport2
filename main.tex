...
That aside, here i covert them all to \textbf{bar}, using the relevnt calcs outlined in subsection \ref{Pressure Units}.
	...
	\begin{tcolorbox}[title={\color{black}\normalsize \textbf{Final Data-Set}}, colback=black!9!white,colframe=black!25!white, boxrule=0.5mm, width=\textwidth] 
		\begin{minipage}{0.23\textwidth}
			\begin{tcolorbox}[title={\color{black}\normalsize \textbf{Pressure Calibrator}}, colback=SkyBlue!6!white, 
...
\begin{tblr}{		
	...
	Bundenburg Gauge & 0.9932 & {\color{red!0.68!black} 0.68\%} & 0.9416 & {\color{red!5.84!black} 5.84\%} & 0.9483 & {\color{red!5.17!black} 5.17\%} \\\hline	
