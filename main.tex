...
\begin{table}[ht]
	...
	\begin{tabular}{lcccc}
		\toprule
		\textbf{Unit} & \textbf{Pa} & \textbf{bar} & \textbf{psi} & \textbf{atm} \\
		\midrule
		Pa            & 1           & $1 \times 10^{-5}$ & $1.450 \times 10^{-4}$ & $9.869 \times 10^{-6}$ \\
		bar           & $1 \times 10^{5}$ & 1            & 14.5038      & 0.986923     \\
		psi           & 6894.76     & 0.0689476    & 1            & 0.068046     \\
		atm           & 101325      & 1.01325      & 14.6959      & 1            \\
		\bottomrule
	\end{tabular}
...
\begin{center}
\fbox{\hspace*{-0.5em}\begin{minipage}{0.46\textwidth}\centering		\begin{tikzpicture}
		\draw[thick,->] 
		(-1,3) 
		.. controls (-0.5,4) and (2.5,4) .. 
		(3,3)  
		node[above,midway] {to Bar Units} 
		node[below,midway] {$\times 10^{-2}$};
	\end{tikzpicture}\\
	\hspace*{1em}
	\begin{minipage}{1\textwidth}
\fbox{\begin{minipage}{0.4\textwidth}\centering
	\textbf{\textsf{kPa}}\\[8pt]
	\begin{tblr}{
			colspec={X[1cm]X[1cm]},
			hlines,vlines,
	...
	\end{tblr}
\end{minipage}}
\fbox{\begin{minipage}{0.43\textwidth}\centering
	\textbf{\textsf{Bar}}\\[8pt]
	\begin{tblr}{
