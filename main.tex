...
\begin{enumerate}
	...
	\end{equation}
	The ratio $k_i/k_c$ cancels when comparing the same instrument across units, preserving gradients.
	\item \textbf{Dimensional Consistency}: 
	The gradient $\frac{\Delta P_{\text{inst}}}{\Delta P_{\text{cal}}}$ is naturally dimensionless, making it invariant under unit changes.
	...
	\begin{itemize}
		...
		\item The relative scaling ($k_i/k_c$)
	\end{itemize}
...
\subsection{ Interpretation of Key Findings} The accuracy of pressure readings from four gauges—the Hg Manometer, the Borden Gauge 1, the Borden Gauge 2, and the Bundenburg Gauge—has been thoroughly assessed.  This evaluation gives us an overall performance rating and provides important information on the performance of each gauge in vacuum and pressurization ranges. Three principal findings emerge:  
