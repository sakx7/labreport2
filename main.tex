...
\begin{center}
	...
	\begin{minipage}{0.46\textwidth}
		...
		\begin{tikzpicture}[scale=2,transform shape]
			...
			\fill[blue!70!black] (c1) -- (c2) -- (c3) -- (c4) -- cycle;
			\begin{scope}
				\clip (c1) -- (c2) -- (c3) -- (c4) -- cycle;
				\begin{scope}[canvas is xz plane at y=0]
					\shade[inner color=red, outer color=blue!70!black, shading=radial] 
					(0,0) circle (1.36cm);
					\shade[inner color=red, outer color=blue!70!black, shading=radial] 
					(0,0) circle (1.2cm);
				\end{scope}
		...
		\vspace{1em}Average pressure assumes uniform distribution. Local pressure reveals real-world stress hotspots.
\end{minipage}\end{center}
The type of deflection caused by pressure depends on its magnitude and the duration of application. Pressure has numerous examples and applications, such as vehicle tires and press machines.\\[8pt]
...
\begin{tikzpicture}[scale=2,transform shape]	
	...
	\node[right] at (0,\lapy*2.4) {\small\wm{0.2}{\textsf{Positive\\ Pressure}}};
	\node[right] at (0,\lapy-\lapy) {\small\wm{0.2}{\textsf{Negative\\ Pressure\\ (Vacuum)}}};
	\node[left=-0.2cm] at (\floorx*0.5,-0.5) {\wm{0.3}{\small\textsf{Absolute Zero Pressure}}};
\end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\end{tblr}
\end{center}	\vspace{-1em}\captionof{table}{Standard Pressure Unit Conversions}
