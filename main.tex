...
\begin{document}
	...
	\begin{tblr}{
		...
		Varley, Freddie & Mechanical Engineering & Theory &  \includegraphics[width=2cm,valign=c]{images/profile.png}\\
		Abdul Mueed & Mechanical Engineering  & \wm{0.1}{Theory\\ \small in progress} & \includegraphics[width=2cm,valign=c]{images/profile.png} \\ 
		Abdelrahman Shehata & Mechanical Engineering  & \wm{0.2}{Discussion of results\\ \small in progress} & \includegraphics[width=2cm,valign=c]{images/profile.png}\\\hline
		Naim Alrifai & Mechanical Engineering & in-person encounters, internet ghosts & \includegraphics[width=2cm,valign=c]{images/Image(9).jpeg} \\ 
...
\end{enumerate}
	...
	\begin{tcolorbox}[title={\color{black}\normalsize \textbf{Original Data-Set}}, colback=black!4!white,colframe=black!10!white, boxrule=0.5mm, width=1\textwidth] 
	...
	\hspace*{-2.2em}	
	\begin{minipage}{1.1\textwidth}	
	\begin{tcolorbox}[title={\color{black}\normalsize \textbf{Zeroed out Data-Set}}, colback=black!4!white,colframe=black!10!white, boxrule=0.5mm, width=\textwidth] 
	\begin{minipage}{0.23\textwidth}
		\begin{tcolorbox}[title={\color{black}\normalsize \textbf{Pressure Calibrator}}, colback=SkyBlue!6!white, 
			colframe=SteelBlue!10!white, boxrule=0.5mm, width=\textwidth]
			\hspace*{-0.82em}
...
In the context of this study, as seen in the table in Figure \ref{fig:pressurestable}, we are provided with a row for calculating bar and bar \(\text{P}_\text{abs}\), which directly suggests that all the pressures should be expressed in bar for all comparisons. The selection of unit does not substantially influence the outcomes of the conclusions we seek to get. I will later demonstrate that the results remain consistent across multiple pressure unit conversions.\\[8pt]
...
\restoregeometry
	...
	Since the desired ideal value for the gradient is 1, we can calculate the percentage error using the following formula:
	\begin{equation}
...
\begin{figure}[H]
	...
	\begin{tikzpicture}[scale=1.2]
		\begin{axis}[
			...
			% Combined Gradient (green)
			\addplot[green!70!black, fill=green!30] 
